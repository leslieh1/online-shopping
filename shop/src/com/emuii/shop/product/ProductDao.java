...
public class ProductDao extends HibernateDaoSupport{
    ...
    public List<Product> findNew() {
        List<Product> list = (List<Product>) this.getHibernateTemplate().executeFind(new PageHibernateCallback<Product>("from Product order by pdate desc", null , 0, 10));
        return list;
    }
    ...
    public List<Product> findByPage(Integer cid, int begin, int limit) {
        ...
        List<Product> list = (List<Product>) this.getHibernateTemplate().executeFind(new PageHibernateCallback<Product>(hql, new Object[]{cid}, begin, limit));
        return list;
    }
    ...
    public List<Product> findByPageCsid(Integer csid, int begin, int limit) {
        ...
        List<Product> list = (List<Product>) this.getHibernateTemplate().executeFind(new PageHibernateCallback<Product>(hql, new Object[]{csid}, begin, limit));
        return list;
    }
    ...
    public List<Product> findByPage(int begin, int limit) {
        ...
        List<Product> list = (List<Product>) this.getHibernateTemplate().executeFind(new PageHibernateCallback<Product>(hql, null, begin, limit));
        if(list.size() > 0){
            return list;
        }
        return null;
