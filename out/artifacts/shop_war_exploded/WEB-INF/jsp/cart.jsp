    ...
    <div class="span24">
        <s:if test=" #session.cart == null || #session.cart.cartItems.size() == 0">
            <div class="step step1">
                <center><strong><font color="#dcdcdc" size="5">呜呜呜~购物车是空的</font> </strong></center>
            </div>
        </s:if>
        <s:else>
            <div class="step step1">
                <strong><font color="#dcdcdc" size="5">购物车列表</font> </strong>
            </div>
            <table>
                <tbody>
                <tr>
                ...
                <s:iterator value="#session.cart.cartItems">
                    <tr>
                        ...
                        <td>
                            <a href="${pageContext.request.contextPath}/cart_removeCart?pid=<s:property value="product.pid" />"
                               class="delete">删除</a>
                        </td>
                    </tr>
                </s:iterator>
            ...
            <div class="bottom">
                ...
                <a href="${ pageContext.request.contextPath }/order_saveOrder.action" id="submit"
                   class="submit">提交订单</a>
            </div>
        </s:else>
    </div>
