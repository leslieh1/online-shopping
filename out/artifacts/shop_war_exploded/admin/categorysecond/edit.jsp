    ...
    <table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
        ...
        <tr>
            ...
            <td class="ta_01" bgColor="#ffffff" colspan="3">
                <input type="hidden" name="csid" value="<s:property value="model.csid" />" class="bg"/>
            ...
            <td class="ta_01" bgColor="#ffffff" colspan="3">
                <select name="cid">
                    <s:iterator var="c" value="cList">
                        <%--<option value="<s:property value="#c.cid"/>" <s:if test=" '<s:property value='#c.cid'/>' == <s:property value='model.category' />">selected</s:if>><s:property value="#c.cname"/></option>--%>
                        <s:if test="<s:property value='#c.cid'/> == <s:property value='model.category.csname' />">
